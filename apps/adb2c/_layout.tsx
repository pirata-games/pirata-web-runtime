              ...
              <div class='bg-white dark:bg-slate-800 shadow-lg rounded-lg p-8 md:p-12 max-w-lg w-full transform transition-transform duration-300 hover:scale-115 hover:shadow-2xl mt-10'>
                ...
                <div class='
                    ...
                    [&>#api_.buttons>button]:w-full 
                      [&>#api_.buttons>button#cancel]:mt-2  
                      [&>#api_.buttons>button#cancel]:bg-transparent 
                      [&>#api_.buttons>button#cancel]:border 
                      [&>#api_.buttons>button#cancel]:border-gray-500 
                      [&>#api_.buttons>button#cancel]:hover:bg-gray-100 
                      dark:[&>#api_.buttons>button#cancel]:border-gray-400 
                      dark:[&>#api_.buttons>button#cancel]:hover:bg-gray-700
