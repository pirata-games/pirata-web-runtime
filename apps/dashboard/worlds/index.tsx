...
> = {
  ...
  async POST(req, ctx) {
    ...
    const worldLookup = (formData.get('worldLookup') as string) ?? crypto.randomUUID();
  ...
  return (
    <div class='p-6'>
          ...
          <>
            ...
            <div class='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              ...
              <Action
                ...
                disabled={loading}
                onClick={() => toggleEditWorld('', { Details: {} } as EaCGameWorldAsCode)}
              >
                Create World
              </Action>
            </div>
      ...
      {editWorld && (
        <>
          <h1 class='text-3xl font-semibold text-center my-8'>
            {editWorld[1].Details?.Name ? `Manage ${editWorld[1].Details?.Name}` : 'Create World'}
          </h1>
          ...
          >
            {editWorld[0] && <input type='hidden' name='worldLookup' value={editWorld[0]} />}
